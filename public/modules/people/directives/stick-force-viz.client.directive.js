...
angular.module('people').directive('stickForceViz', [ 'People',
    function(People) {
		return {
			...
			link: function (scope, element, attrs) {
                ...
                //Wrapper to let d3 data access scope
                scope.getD3Data = People.query(function(){
                    
                    var data = [];
                    
                    for (var i = 0; scope.getD3Data.length > i; i++){
                        //console.log(scope.newTest[i]);
                        data.push(scope.getD3Data[i]);
                    }
                    
                    //Begin Sanity Check
                    console.log('getD3Data');
                    console.log(scope.getD3Data);
                    //End Sanity Check
                ...
                //End Wrapper to let d3 data access scope
